            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="list-item mb-2"><a href="register-domain.html" class="footer-link"><i class="bi bi-envelope-plus me-3 tx-18"></i>recyloop@company.com</a></li>
                        <li class="list-item"><a href="register-domain.html" class="footer-link"><i class="bi bi-geo-alt me-3 tx-18"></i>Tangerang Selatan, Banten </a></li>
                    </ul>
                    <div class="footer-btn-list d-flex align-items-center mt-4">
                        <a href="<?= base_url() ?>javascript:void(0);" class="footer-btn btn btn-icon btn-info-dark rounded-circle me-2"><i class="bi bi-facebook"></i></a>
                        <a href="javascript:void(0);" class="footer-btn btn btn-icon btn-info-dark rounded-circle me-2"><i class="bi bi-linkedin"></i></a>
                        <a href="<?= base_url() ?>javascript:void(0);" class="footer-btn btn btn-icon btn-info-dark rounded-circle me-2"><i class="bi bi-instagram"></i></a>
                        <a href="<?= base_url() ?>javascript:void(0);" class="footer-btn btn btn-icon btn-info-dark rounded-circle"><i class="bi bi-twitter"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    <h4 class="text-white">Tentang Kami</h4>
                    <ul class="list-unstyled footer-icon">
                        <li class="list-item mb-2"><a href="<?= base_url('about#about'); ?>" class="footer-link">Siapa
                                kita ?</a></li>
                        <li class="list-item mb-2"><a href="<?= base_url('about#tech'); ?>" class="footer-link">Technical Support</a>
                        </li>
                        <li class="list-item mb-2"><a href="<?= base_url('about#team'); ?>" class="footer-link">Tim Kami
                            </a>
                        </li>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="d-md-flex align-items-center">
                        ...
                        <div class="mt-3 mt-md-0">
                            <svg xmlns="http://www.w3.org/2000/svg" class="me-2 mb-2 mb-sm-0 payment-cards" width="80" height="50" enable-background="new 0 0 48 48" viewBox="0 0 48 48">
                                <polygon fill="#fff" points="17.202 32.269 21.087 32.269 23.584 16.732 19.422 16.732" />
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="me-2 mb-2 mb-sm-0 payment-cards" width="80" height="50" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                ...
                <div class="col-lg-5">
                    <ul class="list-unstyled d-sm-flex mb-0 justify-content-lg-end mt-3 mt-lg-0 ">
                        <li class="list-item"><a href="terms-of-service.html" class="footer-link px-3 border-end border-white-2 op-8">Terms of Service</a></li>
                        <li class="list-item"><a href="privacy-policy.html" class="footer-link px-3 border-end border-white-2 op-8">Privacy Policy</a></li>
