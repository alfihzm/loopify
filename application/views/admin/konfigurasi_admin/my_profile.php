            ...
            <div class="row">
                <div class="col-12 col-sm-9 col-md-4 mb-2">
                    <div class="card mb-3 p-3 border border-secondary" style="display: flex; flex-direction: column; align-items: center;">
                        <img src="<?= base_url('assets/images/user/profile/') .  $user['photo']; ?>" class="border border-secondary card-img-top rounded-circle" alt="..." style="max-height: 40%; max-width: 40%;">
                    ...
                    <div class="card mb-3 p-3 border border-secondary">
                        ...
                        <div class="form-group row">
                            <label for="notelp" class="col-sm-3 col-form-label">No.
                                Telp</label>
                            <div class="col-sm-9">
                                <input style="color:#000;" type="text" class="form-control" id="notelp" name="notelp" readonly value="<?= $user['no_telp']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="date_created" class="col-sm-3 col-form-label">Akun</label>
                            <div class="col-sm-9">
                                <input style="color:#000;" readonly type="text" class="form-control" id="date_created" name="date_created" value="<?= date('d F Y', $user['date_created']); ?>">
                                <?php
