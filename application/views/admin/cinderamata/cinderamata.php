                        ...
                        <tr>
                            ...
                            <td>
                                <img class="mb-2 mt-2" style="border: 1px solid #FFF; border-radius: 5px;"
                                    src="<?= base_url('assets/images/cinderamata/' . $c['photo']); ?>" alt="Gambar"
                                    width="85" height="85">
                            </td>
                            <td><?= $c['stok']; ?></td>
                            <td>
                                <a href="<?= base_url('admin/ubah_gift/'   . $c['id']); ?>"
                                    class="btn btn-success btn-sm"><i style="color: #000;"
                                        class="fa-solid fa-pencil"></i></a>

                                <a href="<?= base_url('admin/hapus_gift/' . $c['id']); ?>"
                                    class="btn btn-danger btn-sm"><i style="color: #000;"
                                        class="fa-solid fa-trash"></i></a>

                                <a href="<?= base_url('admin/tambah_stok/' . $c['id']); ?>"
                                    class="btn btn-success btn-sm"><i style="color: #000;"
                                        class="fa-solid fa-plus"></i></a>

                                <a href="#" data-gift-id="<?= $c['id']; ?>" data-toggle="modal"
                                    data-target="#giveGiftModal" class="btn btn-success btn-sm giveGiftBtn">
                ...
                <form action="<?= base_url('admin/cinderamata/tambah_stok') ?>" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input style="background: #01E7f4; color: #1A2035; font-weight: 600;" type="text"
                                class="form-control" id="stok_tersedia" name="stok_tersedia"
