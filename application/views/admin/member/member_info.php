        ...
        <div class="page-inner">
            ...
            <div class="row-lg-12" style="display: flex; justify-content: space-between">
                ...
                <div class="card col-sm-5 col-md-6 col-lg-6 border border-secondary p-4">
                    ...
                    <div class="form-group row">
                        <label for="username" class="col-sm-10 col-form-label">Total Poin</label>
                        <div class="col-sm-12">
                            <input style="color: #000;" type="text" class="form-control" id="username" name="username" readonly value="<?= $user['poin']; ?>">
                        </div>
                    </div>
                </div>
            </div>
