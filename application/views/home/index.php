            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 reveal">
                        <h2 class="mb-1 text-white">Ingin Bergabung Daftarkan Disini</h2>
                        <p class="mb-4 op-7 tx-15">Gabung dan lestarikan alam bersama.</p>
                        <p class="mb-4">
                        ...
                        <div class="card text-center feature-card-16 mb-lg-0 success">
                            <div class="card-body">
                                <svg class="feature-icon br-style1 success mb-3" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path fill="#17ca68" d="M15.7 12.713a5.975 5.975 0 0 1-7.405 0 9.992 9.992 0 0 0-6.23 8.179 1 1 0 0 0 .886 1.102L20.94 22a1 1 0 0 0 .995-1.108 9.995 9.995 0 0 0-6.233-8.179z" />
                                </svg>
        ...
        <section class="section">
            <div class="container">
                <div class="heading-section">
                    ...
                    <div class="heading-description">Foto-foto terbaru kami yang kita documentasikan.</div>
                </div>
                <div class="row">
                    <div class="col-lg-4">
