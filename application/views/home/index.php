            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 reveal">
                        ...
                        <p class="mb-4">
                            Tukar limbah rumah tangga Anda untuk di daur ulang agar limbah tidak berujung menjadi sampah di Tempat Pembuangan Akhir!.
                        </p>
        ...
        <section class="section">
            ...
            <div class="container">
                <div class="heading-section">
                    ...
                    <div class="heading-description">Cara mudah mendapatkan tunai dengan mengurangi residu alam menjadi benda layak pakai.</div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card text-center feature-card-16 mb-lg-0 danger">
                            <div class="card-body">
                                <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42"
                                            fill="var(--primary-color)" class="bi bi-box-seam-fill"
                                            enable-background="new 0 0 3873 3873" viewBox="0 0 448 512"><path d="M177.7 16h92.5c8.3 0 16 4.3 20.4 11.3l23 36.7H134.4l23-36.7c4.4-7 12.1-11.3 20.4-11.3zm-33.9 2.8L115.6 64H8c-4.4 0-8 3.6-8 8s3.6 8 8 8H440c4.4 0 8-3.6 8-8s-3.6-8-8-8H332.4L304.2 18.8C296.9 7.1 284.1 0 270.3 0H177.7c-13.8 0-26.6 7.1-33.9 18.8zM48 119.3c-.4-4.4-4.2-7.7-8.6-7.3s-7.7 4.2-7.3 8.6l28.3 340c2.4 29 26.7 51.4 55.8 51.4H331.8c29.1 0 53.4-22.3 55.8-51.4l28.3-340c.4-4.4-2.9-8.3-7.3-8.6s-8.3 2.9-8.6 7.3l-28.3 340C370 480.1 352.6 496 331.8 496H116.2c-20.8 0-38.1-15.9-39.9-36.7L48 119.3z"/></svg>
        ...
        <section class="section">
            <div class="container">
                <div class="heading-section">
                    ...
                    <div class="heading-description">Dari limbah rumah tangga Anda, menjadi barang bernilai yang layak pakai.</div>
                </div>
                <div class="row">
                    <div class="col-lg-4">
