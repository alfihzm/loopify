...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2024 at 04:27 AM
...
(2, 'aruskas', 14991, '2024-05-27', '18:26:40', 'alfihzm');
...
INSERT INTO `sampah` (`id`, `icon`, `jenis_sampah`, `kode`, `nilai_tukar`, `nilai_satuan`, `total_sampah`) VALUES
(1, 'plastic-bottle.png', 'Botol Plastik', 'BP', 1500, 55, 5),
(2, 'tin-can.png', 'Kaleng', 'KA', 13300, 200, 11),
(3, 'zinc.png', 'Limbah Seng', NULL, 2500, 0, 0),
(4, 'book.png', 'Kardus', 'KK', 2500, 500, 3);
...
(1, NULL, NULL, 10480001, 'Betara', '1999-01-01', 'betara@gmail.com', 'betara', '$2y$10$FLuzN7X92R2TQFttbmiQDOacjuIKMV8NnqPrjLrGdU.ow1DNxVEhu', 3, 'default.jpg', '082161872392', 'Jakarta Selatan', 0, 0, 999990, NULL, 1712325370, 1),
